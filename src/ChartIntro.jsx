  ...
  render() {
    ...
    return (
      <React.Fragment>
        ...
        <p><a style={{color: 'blue', cursor: 'pointer'}} onClick={() => {this.props.closePage('needToIntroduceChart'), this.props.closePage('needCaloriesIn'), this.props.closePage('needCaloriesOut')}}>Start logging</a> your calories.</p>
      </React.Fragment>
    )
  }
}
